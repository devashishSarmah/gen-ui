...
@Component({
  ...
  styles: [`
    ...
    .alert-success {
      background: linear-gradient(135deg, rgba(46, 255, 139, 0.18), rgba(0, 255, 245, 0.18));
      border: 1px solid rgba(46, 255, 139, 0.3);
      color: var(--ds-accent-teal);
      box-shadow: 0 4px 16px rgba(46, 255, 139, 0.2);
    }
