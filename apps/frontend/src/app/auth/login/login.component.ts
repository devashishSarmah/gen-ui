...
import { LucideAngularModule, Mail, Lock, LogIn, Loader2, Github, Chrome } from "lucide-angular";
    ...
    <div class="h-dvh w-full flex items-center justify-center">
      <div class="auth-container">
        <div class="auth-header">
          <h2>Welcome back</h2>
          <p class="auth-subtitle">Sign in to continue building interfaces</p>
        </div>
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
          ...
          >
            @if (isLoading) {
              ...
              <lucide-icon [img]="LogIn" [size]="16"></lucide-icon>
              Sign in
            }
          </button>
        </form>
