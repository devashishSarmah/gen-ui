  ...
  examplePrompts: ExamplePrompt[] = [
    {
      icon: ClipboardList,
      title: 'Contact Form',
      description: 'Form with name, email & message fields',
      prompt: 'Create a contact form with name, email, and message fields with validation',
    },
    {
      icon: BarChart3,
      title: 'Sales Dashboard',
      description: 'Charts, KPIs & revenue table',
